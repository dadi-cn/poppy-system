...
class ConfigurationTest extends TestCase
{
	...
	{
		$type = config('module.system.category_types');
		$this->assertInternalType('array', $type, 'Category Types not set in `module.system.category_types`');
	}

	public function testSettings()
	{
		$pamPrefix = sys_setting('system::pam.prefix');
