...
trait RbacUserTrait
{
	...
	/**
	 * @return Collection|PamRole[]
	 */
	public function cachedRoles()
	{
		static $cache;
		$userPrimaryKey = $this->primaryKey;
		$cacheKey       = 'rbac_roles_for_user_' . $this->$userPrimaryKey;
		if (!isset($cache[$cacheKey])) {
			$cache[$cacheKey] = sys_cache('system:rbac_user')->remember($cacheKey, config('cache.ttl'), function () {
	...
	{   //both inserts and updates
		parent::save($options);
		sys_cache('system:rbac_user')->flush();
	}
