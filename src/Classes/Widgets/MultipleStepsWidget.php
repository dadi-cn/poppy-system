...
class MultipleStepsWidget implements Renderable
{
	/**
	 * @var int|string
	 */
	...
	public function render()
	{
		...
		if (!is_subclass_of($class, StepFormWidget::class)) {
			admin_error("Class [{$class}] must be a sub-class of [Poppy\System\Classes\Widgets\StepForm].");

			return;
		}

		/** @var StepFormWidget $step */
		$step = new $class();
