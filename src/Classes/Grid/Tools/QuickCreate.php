...
use Poppy\System\Classes\Form\Field\MultipleSelect;
use Poppy\System\Classes\Form\Field\Select;
use Poppy\System\Classes\Form\Field\Text;
...
class QuickCreate implements Renderable
{
    ...
    protected function resolveView($class)
    {
        ...
        return "py-system::tpl.grid.quick-create.{$name}";
    }
...
SCRIPT;
    ...
    public function render($columnCount = 0)
    {
        ...
        return view('py-system::tpl.grid.quick-create.form', $vars)->render();
    }
}
