...
use Poppy\System\Classes\Admin;
...
class Field implements Renderable
{
	...
	public function getViewElementClasses()
	{
		if ($this->horizontal) {
			return [
				'label'      => "layui-form-label col-sm-{$this->width['label']} {$this->getLabelClass()}",
				'field'      => "layui-input-block col-sm-{$this->width['field']}",
	...
	public function getView(): string
	{
		...
		return 'system::tpl.form.' . strtolower(end($class));
	}
	 ...
	 *
	 * @return \Poppy\System\Classes\Form\Field
	 */
