...
<body bgcolor="#e4e4e4" topmargin="0" leftmargin="0" marginheight="0" marginwidth="0"
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#e4e4e4">
    <tr>
        <td bgcolor="#e4e4e4" width="100%">
            ...
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="table">
                <tr>
                    <td width="600" class="cell">
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0" class="table">
                            <tr>
                                <td width="250" bgcolor="#e4e4e4" class="logocell">
                                    <img border="0"
                                         src="{{ url('assets/images/system/spacer.gif') }}"
                                         width="1" height="20" class="hide">
                                    <br class="hide">
                                    @if (isset($logo))
                                        <img src="{{ array_key_exists('path', $logo) ? $logo['path'] : '' }}"
                                             width="{{ array_key_exists('width', $logo) ? $logo['width'] : '' }}"
                                             height="{{ array_key_exists('height', $logo) ? $logo['height'] : '' }}"
                                             alt="{{ $title ?? '' }}" style="-ms-interpolation-mode:bicubic;">
                                    @endif
                                    <br>
                                    <img border="0"
                                         src="{{ url('assets/images/system/spacer.gif') }}"
                        ...
                        <img border="0" src="{{ url('assets/images/system/spacer.gif') }}"
            ...
            <img border="0" src="{{ url('assets/images/system/spacer.gif') }}" width="1"
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#f2f2f2">
                <tr>
                    <td>
                        ...
                        <img border="0" src="{{ url('assets/images/system/spacer.gif') }}" alt="{!! $title ?? '' !!}"
                                                        ...
                                                        @if (isset($twitter))
                                                            <td>
                                                                <a href="https://twitter.com/{{ $twitter }}">
                                                                    <img border="0"
                                                                         src="{{ Request::getSchemeAndHttpHost() }}/vendor/beautymail/assets/images/widgets/twitter.gif"
                                                                         width="42" height="32"
